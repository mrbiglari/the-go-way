...
1. ✅ [Hello World](tutorial/1-hello-world.go/)
1. ✅ [Values](tutorial/2-values.go/)
1. ✅ [Variables](tutorial/3-variables.go/)
1. ✅ [Constants](tutorial/4-constants.go/)
1. ✅ [for](tutorial/5-for.go/)
1. ✅ [if/else](tutorial/6-if-else.go/)
1. ✅ [switch](tutorial/7-switch.go/)
1. ✅ [arrays](tutorial/8-arrays.go/)
1. ✅ [slices](tutorial/9-slices.go/)
